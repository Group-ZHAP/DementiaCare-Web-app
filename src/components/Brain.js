...
function Brain() {
  return (
    <div>
      ...
      <h3
        style={{ textAlign: "center", color: "#4A0D66", paddingBottom: "20px" }}
      >
        {" "}
      ...
      <p style={{ textAlign: "center", padding: "45px" }}>
      ...
      <div style={{ background: "#4A0D66" }}>
        <center>
          <h1 style={{ padding: "25px", color: "white" }}>NEURON FOREST :</h1>
        </center>
      </div>
      ...
      <p style={{ textAlign: "center", color: "#4A0D66", padding: "33px" }}>
      ...
      <center>
        <p style={{ textAlign: "center", width: "50vw" }}>
